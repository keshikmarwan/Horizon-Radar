...
DEMO_TOPICS = [
    {
        ...
        'title': 'Data-enabled resilient manufacturing systems TRL 5-7',
        'cluster': 'CL4',
        'action_type': 'RIA',
        'trl_min': 5,
        'trl_max': 7,
        'expected_outcomes': 'Increase resilience and autonomy of EU manufacturing plants through data and robotics.',
    ...
    },
    {
        ...
        'scope': 'Include data-based diagnostics, digital battery passport and interoperability APIs.',
